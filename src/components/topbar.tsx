  ...
  return (
    <>
      ...
      <header className="fixed top-0 right-0 left-0 z-20">
          ...
          <div className="mx-auto flex h-full w-full max-w-[96rem] items-center justify-between gap-x-24">
            <div className="flex gap-x-24">
              ...
              <nav className="flex items-center gap-x-24">
                ...
                <p className="text-15 font-300 text-[#1d1115]">Resources</p>
                <p className="text-15 font-300 text-[#1d1115]">Company</p>
              </nav>
            </div>
        ...
        <div
          className="absolute inset-0 -z-10 bg-white shadow-[0px_1px_4px_rgba(0,0,0,0.12)]"
          style={{ opacity: scrollY / 128 }}
        />
      </header>
